...
class Config:
    ...
    GENERAL = 0
    WEB = 1
    SECTIONS = ["general", "webServer",]

    STRING_KEYS =["msgFormat", "logFileName", "endPoint", "webRoot", "default", "gpio", "name_de", "name_en",
                  "name_pl", "headline", "address", "fs20Data", "roamingAddress", "database", "sqlScripts", "id"]
    INT_KEYS =["maxFilesize", "logLevel", "switchCount", "peerCount", "fs20Count", "ultrasonicCount",
               "temperatureCount", "min", "max", "resolutionX", "resolutionY"]
    BOOLEAN_KEYS =["enableLogging", "inverse"]

    DEFAULTS ={"enableLogging" :"yes",
                "logFileName": "/tmp/prc.log",
                "maxFilesize": 1000000,
